<script>
	// This is a placeholder route for package building
	// The actual package exports are in src/lib/
</script>
...
<div class="min-h-screen bg-gray-50 flex items-center justify-center p-8">
	<div class="max-w-2xl text-center">
		...
		<div class="flex gap-4 justify-center">
			<a
				href="/demo"
				class="inline-flex items-center gap-2 px-6 py-3 text-sm font-medium text-white bg-indigo-600 rounded-md hover:bg-indigo-700"
			>
				View Demo
			</a>
			<a
